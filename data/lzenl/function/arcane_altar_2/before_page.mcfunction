##
 # before_page.mcfunction
 # 
 #
 # Created by .
##
item replace block ~ ~-1 ~ container.8 with poisonous_potato[item_name="execute",custom_name={text:"Up",color:white,italic:false},item_model="flint",consumable={consume_seconds:999,sound:"intentionally_empty",animation:"none"},tooltip_display={hidden_components:["tooltip_display"]}] 1
