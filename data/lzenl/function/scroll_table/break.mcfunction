...
kill @s
summon item ~ ~-0.5 ~ {PickupDelay:2,Motion:[0.0,0.1,0.0],Item:{id:"minecraft:stone_pickaxe",count:1,components:{custom_data:{item:{id:12b,type:2b}},"minecraft:item_model":"enchanting_table","minecraft:item_name":"Scroll Table","!minecraft:tool":{},"minecraft:consumable":{consume_seconds:0,animation:"none",sound:"intentionally_empty",has_consume_particles:false},"!minecraft:attribute_modifiers":{}}}}
return 1