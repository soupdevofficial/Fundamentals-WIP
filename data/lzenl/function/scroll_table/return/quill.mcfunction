...
give @p[tag=user,distance=..7] gold_nugget[item_name="Enchanting Quill",enchantment_glint_override=true,rarity=rare,damage=10,max_damage=10,max_stack_size=1,item_model=spectral_arrow]
