...
give @p[tag=user,distance=..7] paper[item_name="Windcharge Scroll",enchantment_glint_override=true,rarity=rare,item_model=filled_map,custom_data={return:1b,spell:{type:2b},weapon:{element:2b}},map_id=-1,map_color=9819352,consumable={animation:"crossbow",has_consume_particles:false,sound:intentionally_empty,consume_seconds:0.0},use_cooldown={seconds:2.5,cooldown_group:spell}]
