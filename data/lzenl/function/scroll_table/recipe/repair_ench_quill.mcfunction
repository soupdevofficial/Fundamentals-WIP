...
execute unless items block ~ ~-1 ~ container.11 gold_nugget[item_name="Enchanting Quill",enchantment_glint_override=true,rarity=rare,!damage=0,max_damage=10,max_stack_size=1,item_model=spectral_arrow] run return fail
