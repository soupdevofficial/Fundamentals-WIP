...
execute unless items block ~ ~-1 ~ container.2 ender_pearl run return fail
execute unless items block ~ ~-1 ~ container.10 ender_pearl run return fail
...
execute unless items block ~ ~-1 ~ container.12 ender_pearl run return fail
...
execute unless items block ~ ~-1 ~ container.20 ender_pearl run return fail
