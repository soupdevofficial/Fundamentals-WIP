##
 ...
 # Created by .
##
execute unless items block ~ ~-1 ~ container.2 wind_charge run return fail
execute unless items block ~ ~-1 ~ container.10 wind_charge run return fail
...
execute unless items block ~ ~-1 ~ container.12 wind_charge run return fail
...
execute unless items block ~ ~-1 ~ container.20 wind_charge run return fail
return 1