...
execute if score .temp .data matches -45..45 as @e[type=item_display,tag=wet_clay_bucket,distance=..0.5] run rotate @s -90 0

execute if score .temp .data matches 46..135 as @e[type=item_display,tag=wet_clay_bucket,distance=..0.5] run rotate @s 0 0

execute if score .temp .data matches 136..180 as @e[type=item_display,tag=wet_clay_bucket,distance=..0.5] run rotate @s 90 0

execute if score .temp .data matches -180..-136 as @e[type=item_display,tag=wet_clay_bucket,distance=..0.5] run rotate @s 90 0

execute if score .temp .data matches -135..-46 as @e[type=item_display,tag=wet_clay_bucket,distance=..0.5] run rotate @s 180 0
