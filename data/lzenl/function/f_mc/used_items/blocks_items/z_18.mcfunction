...
execute unless items entity @s weapon.mainhand poisonous_potato[custom_data~{item:{drill:1b}}] unless items entity @s weapon.mainhand poisonous_potato[custom_data~{item:{drill:2b}}] unless items entity @s weapon.mainhand poisonous_potato[custom_data~{item:{drill:3b}}] unless items entity @s weapon.mainhand poisonous_potato[custom_data~{item:{drill:4b}}] run return run title @s actionbar {color:red,text:"Drill has to be in Mainhand!"}
