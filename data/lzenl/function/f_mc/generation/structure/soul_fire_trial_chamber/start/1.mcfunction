##
 ...
 # Created by .
##
place template lzenl:soul_fire_trial_chamber_main ~-5 ~ ~ none none
scoreboard players set #rotation .data 2
execute positioned ~ ~ ~10 run function lzenl:f_mc/generation/structure/soul_fire_trial_chamber/path_end
