##
 ...
 # Created by .
##
place template lzenl:soul_fire_trial_chamber_main ~5 ~ ~ clockwise_90 none
scoreboard players set #rotation .data 4
execute positioned ~-5 ~ ~5 run function lzenl:f_mc/generation/structure/soul_fire_trial_chamber/path_end

scoreboard players set #rotation .data 3
execute positioned ~6 ~ ~6 run function lzenl:f_mc/generation/structure/soul_fire_trial_chamber/path
