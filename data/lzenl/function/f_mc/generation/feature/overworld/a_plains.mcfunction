...
execute if score #return .data matches 502 run return run function lzenl:f_mc/generation/feature/overworld/f_aurora
execute if score #return .data matches 503 run return run function lzenl:f_mc/generation/feature/end/rift/generate
