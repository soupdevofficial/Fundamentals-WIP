...
execute if entity @s[tag=normal] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.1
execute if entity @s[tag=magic] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.2
execute if entity @s[tag=infernal] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.3
execute if entity @s[tag=dark] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.4
execute if entity @s[tag=light] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.5
execute if entity @s[tag=abyssal] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.6
...
execute if entity @s[type=#normal] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.1
execute if entity @s[type=#magic] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.2
execute if entity @s[type=#infernal] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.3
execute if entity @s[type=#dark] run data modify storage f_mc:combat data.element_multiplier append from storage f_mc:combat data.got.4
