...
execute as @s[tag=!vul] if score #armor_break .data matches 1 if score #armor_active .data matches 1.. run function lzenl:f_mc/gameplay/combat/armor/armor_damage_start
