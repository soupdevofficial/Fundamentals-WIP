...
execute anchored eyes positioned ^ ^ ^ as @e[distance=..1,tag=display,tag=!set,limit=1,type=item] run function lzenl:f_mc/gameplay/combat/dmg_indicator_motion with storage temp data.motion