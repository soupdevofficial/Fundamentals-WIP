...
## Blocks
 ...
 #rock/pebble/sticks
 execute as @e[tag=fundamentals.block.stick,type=interaction,distance=..7] if data entity @s interaction at @s run function lzenl:f_mc/blocks/stick/pick_up
 execute as @e[tag=fundamentals.block.rock,type=interaction,distance=..7] if data entity @s interaction at @s run function lzenl:f_mc/blocks/rock/pick_up
 #campfire
...
## Heroes
 ...
 execute as @e[tag=fundamentals.heroes.aurora,type=interaction,distance=..7] if data entity @s interaction run function lzenl:f_mc/gameplay/combat/hero/aurora/find
