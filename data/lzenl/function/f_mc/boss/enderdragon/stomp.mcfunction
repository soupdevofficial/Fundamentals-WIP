...
execute as @e[distance=..20,tag=!dragon,type=!#not_mob] run damage @s 25 minecraft:mace_smash by @n[type=slime,tag=dragon_hp,distance=..18] from @n[type=minecraft:slime,tag=dragon_hp,distance=..15] 
