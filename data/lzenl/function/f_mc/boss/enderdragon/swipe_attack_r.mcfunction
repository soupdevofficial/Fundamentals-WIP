...
execute positioned ^1 ^ ^1 as @e[distance=..4,tag=!dragon,type=!#not_mob] run damage @s 20 mob_attack by @n[type=slime,tag=dragon,distance=..240] from @n[type=slime,tag=dragon,distance=..240]
