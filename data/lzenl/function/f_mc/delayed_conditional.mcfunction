...
#combat stuff
execute if score #htm .data matches 1 at @a[tag=attacker_prev] as @e[distance=..100] if function lzenl:f_mc/gameplay/combat/run_as_entity run function lzenl:f_mc/gameplay/combat/hit
