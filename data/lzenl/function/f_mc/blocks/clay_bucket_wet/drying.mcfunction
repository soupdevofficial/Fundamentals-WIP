...
execute unless score @s .data matches 5.. run return fail

particle cloud ~ ~0.5 ~ 0.0 0.5 0.0 0.05 4

execute on passengers run function lzenl:f_mc/blocks/clay_bucket_wet/dried

tag @s remove wet_clay_bucket

tag @s add dry_clay_bucket
