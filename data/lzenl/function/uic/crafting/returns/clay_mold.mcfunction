...
clear @p[distance=..1,gamemode=!creative] clay_ball 2

playsound minecraft:entity.villager.work_leatherworker master @a[distance=..10] ~ ~ ~ 1 1.5


give @p[distance=..1] poisonous_potato[!food,consumable={consume_seconds:0,sound:"intentionally_empty",has_consume_particles:false},custom_data={item:{id:9b,type:2}},item_model="minecraft:gray_carpet",item_name="Wet Clay Mold"] 1
