...
item replace entity @p[distance=..1] player.cursor from entity @n[tag=crafting_ui,type=donkey] horse.6


execute store result score #req1 .data run clear @p[distance=..1] stick 0
execute store result score #req2 .data run clear @p[distance=..1] #planks 0
